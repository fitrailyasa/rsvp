                ...
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    <div>
                        ...
                        <h2 className="text-6xl font-medium mt-6">
                            Works with your{" "}
                            <span className="text-lime-400">event tools</span>
                        </h2>

                        <p className="text-white/50 mt-4 text-lg">
                            Our RSVP system integrates seamlessly with the tools
                            you already use, making it easier to manage guests,
                            send invitations, and keep your events organized.
                        </p>
                    </div>
                    <div>
