        ...
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium text-center mt-6 max-w-2xl m-auto">
                    ...
                    <span className="text-lime-400">event RSVPs</span>
                </h2>
                <motion.div
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                        ...
                        >
                            <FeatureCard
                                ...
                                description="Work together with your event team to manage guests and responses."
                            ...
                            >
                                <div className="aspect-video flex items-center justify-center">
                                    ...
                                    <Avatar className="-ml-6 border-transparent z-10">
                                        <div className="rounded-full flex justify-center items-center size-full bg-violet-700">
                                            <Ellipsis size={30} />
                                        </div>
                                    </Avatar>
                                </div>
                        ...
                        >
                            <FeatureCard
                                title="RSVP insights"
                                description="See how many guests confirmed, declined, or haven't responded."
                        ...
                        >
                            <FeatureCard
                                ...
                                description="Manage RSVPs, guests, and reminders quickly."
                ...
                <div className="my-8 flex items-center justify-center flex-wrap gap-2 max-w-3xl m-auto">
                    {features.map((feature) => (
                        <div
                            className="bg-violet-900 border border-white/10 inline-flex px-3 md:px-5 md:py-2 py-1.5 rounded-2xl gap-3 items-center hover:scale-105 transition duration-500 group"
                            key={feature}
                        >
